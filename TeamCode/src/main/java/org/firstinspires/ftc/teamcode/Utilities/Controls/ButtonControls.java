package org.firstinspires.ftc.teamcode.Utilities.Controls;
...
public class ButtonControls {
    ...
    public ButtonControls(Gamepad gamepad){
        ...
        buttons.put(Input.Y,   new Button(() -> src.triangle));
        buttons.put(Input.X,     new Button(() -> src.square));
        buttons.put(Input.A,      new Button(() -> src.cross));
        buttons.put(Input.B,     new Button(() -> src.circle));
